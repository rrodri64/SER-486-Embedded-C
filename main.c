...
* Modified By:
*
* This file is the entry point of the program, and
* contains the main control loop for the ATmega328P
* IIoT device.
*/
...
int main(void)
{
    ...
    /* sign the assignment */
    signature_set("Rebecca","Rodriguez","rrodri64");
    ...
    */
    ...
    while (1)
    {
        ...
        */
        ...
        /* update HTTP socket based on received messages */
        httpsocket_update(SERVER_SOCKET);
